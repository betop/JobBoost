...
"""
            ...
            var $system_prompt {
              value = $input.skip_cover_letter == true ? $resume_system_prompt : $resume_system_prompt ~ "\n\n" ~ $cover_letter_system_prompt
            }
              ...
              try {
                ...
                conditional {
                  if ($parsed_response == null) {
                    ...
                    conditional {
                      if ($input.skip_cover_letter != true) {
                        var.update $cover_letter_text {
