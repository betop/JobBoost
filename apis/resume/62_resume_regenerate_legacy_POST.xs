// BACKUP / ROLLBACK ENDPOINT — exact snapshot of resume/regenerate as of the prompt-hardcoding
// migration. Uses the original DB-rules system prompt mechanism (db.query rule / is_active),
// untouched. Point traffic here if the hardcoded-prompt version of resume/regenerate misbehaves.
...
query "resume/regenerate_legacy" verb=POST {
  api_group = "resume"
  auth = "users"
